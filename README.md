...
在首页选择英语或西班牙语，粘贴带对应语言字幕的 YouTube 视频链接即可开始学习。

![VReply 首页：选择学习语言并导入 YouTube 视频](assets/vreply-home.png)

### 逐句学习

视频与字幕并排显示，可在观看时逐句跟读、查看双语字幕，并使用搜索、循环播放和学习记录等功能。

![VReply 学习页：视频播放与双语字幕逐句练习](assets/vreply-learning.png)
